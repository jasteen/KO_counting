...
#This script takes a KO count table generated by count_KEGG_KO.pl and subsets it based on the categories in ./KO_classes, writing a new KO table for any category that has KO's present in any organism in your original table
